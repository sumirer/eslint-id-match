module.exports = {
    ...
    create(context) {
        ...
        const {camelCaseReg, upCaseReg, reactStateErr, camelCaseErr} = schemaData;
        ...
        return {
            ...
            "VariableDeclaration": function (node) {
                ...
                for (let index = 0; index < values.length; index++) {
                    ...
                    if (value.type === 'VariableDeclarator' && value.init && !valueExcList.includes(value.init.type)) {
            ...
            'ExpressionStatement': function (node) {
                if (node.expression && node.expression.type === 'AssignmentExpression') {
                    ...
                    const isThis = left.object.type === 'ThisExpression';
                    if (!isThis) {
                        return;
                    }
                    ...
                    if (right.type === 'ObjectExpression' && leftName === 'state') {
